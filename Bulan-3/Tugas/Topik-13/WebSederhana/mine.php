...
<body>
    <nav>
        <a href="inde.php" class="mine">Home</a>
    ...
    <div class="allin">
        ...
        <div class="art">
            <?php $tabel = 1 ?>
            <?php foreach($mine as $aku): ?>
        <div class="kart">
            <div><h3><?= $aku['judul']; ?></h3></div>
            <p><?= $aku['isi']; ?></p><br>
            <h6><?= $aku['username'] ?></h6>
            <h6><?= $aku['kategori']; ?></h6><br>
            <?php if(!empty($_SESSION)): ?>
            <a href="edit.php?id=<?= $aku['id'] ?>">edit</a>
            <a href="hapus.php?id=<?= $aku['id']?>">delete</a>
            <?php endif ?>
        </div>
        <?php $tabel++; ?>
        <?php endforeach; ?>
